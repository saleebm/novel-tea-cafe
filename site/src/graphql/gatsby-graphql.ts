...
export type AboutPageQuery = { sanitySiteSettings?: Maybe<(
...
export type HomepageQuery = { sanityPage?: Maybe<{ hero?: Maybe<(
    ...
    )> }>, sanitySiteSettings?: Maybe<{ happyHour?: Maybe<Array<Maybe<TaglineFragment>>>, openGraph?: Maybe<(
      Pick<SanityOpenGraph, 'title' | 'description'>
      & { image?: Maybe<(
        Pick<SanityMainImage, 'alt'>
        & { asset?: Maybe<(
...
export type WeeklyEventsQuery = { sanitySiteSettings?: Maybe<{ happyHour?: Maybe<Array<Maybe<TaglineFragment>>> }>, allSanityWeeklyEvents: { edges: Array<{ node: { monday?: Maybe<DayFragment>, tuesday?: Maybe<DayFragment>, wednesday?: Maybe<DayFragment>, thursday?: Maybe<DayFragment>, friday?: Maybe<DayFragment>, saturday?: Maybe<DayFragment>, sunday?: Maybe<DayFragment> } }> } };
